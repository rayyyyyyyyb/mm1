...
$OutputDir = "E:\OV-OrthKD-R3\student-shortcut-s8-60100c6\outputs\diagnostic\recovery_s8_identity_fixed_gate_seed42"
...
$Artifacts = @()
foreach ($Name in @("s8_training_audit.json", "s8_zero_training_ae.json", "s8_zero_training_predictions.npz", "s8_posthoc_audit.json")) {
