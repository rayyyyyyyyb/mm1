...
| `p0_p1_tests` | PASS | Required regression tests must pass |
...
| `source_manifest_audit` | PASS | 24,800 source records must pass 0-error/0-warning audit |
...
| `teacher_smoke_repeatability` | PASS | Real teacher smoke and repeatability must pass |
...
| `canonical_full_run_guard` | PASS | full_run_blocked must remain true until conference-reproduction review |
